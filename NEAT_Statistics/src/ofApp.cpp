...
#define SPEED_DETERIORATION 0.01
#define SPEED_RATIO_FW_BW 2.0

#define PI 3.14159265359

#define DRIFT_STRENGTH 20


void ofApp::resetCar(int which)
{
	cars[which].origin = { 15.0, -50.0, 10.0 };

	cars[which].car_position.set(cars[which].origin);
	cars[which].car_direction.set(0.0, 1.0, 0.0);
...
void ofApp::setup(){
	...
	roadL.push_back(ofVec3f(10.0, 10.0, 10.0));		roadR.push_back(ofVec3f(45.0, -10.0, 10.0));
	roadL.push_back(ofVec3f(10.0, 20.0, 10.0));		roadR.push_back(ofVec3f(60.0, 20.0, 10.0));
	roadL.push_back(ofVec3f(15.0, 40.0, 10.0));		roadR.push_back(ofVec3f(70.0, 40.0, 10.0));
	roadL.push_back(ofVec3f(10.0, 100.0, 10.0));	roadR.push_back(ofVec3f(80.0, 120.0, 10.0));
	roadL.push_back(ofVec3f(-10.0, 90.0, 10.0));	roadR.push_back(ofVec3f(-40.0, 130.0, 10.0));
	roadL.push_back(ofVec3f(-20.0, 80.0, 10.0));	roadR.push_back(ofVec3f(-55.0, 100.0, 10.0));
	roadL.push_back(ofVec3f(-90.0, -10.0, 10.0));	roadR.push_back(ofVec3f(-175.0, -10.0, 10.0));
	roadL.push_back(ofVec3f(-30.0, -100.0, 10.0));	roadR.push_back(ofVec3f(-62.0, -150.0, 10.0));
	roadL.push_back(ofVec3f(-15.0, -90.0, 10.0));	roadR.push_back(ofVec3f(10.0, -150.0, 10.0));
	roadL.push_back(ofVec3f(10.0, 10.0, 10.0));		roadR.push_back(ofVec3f(45.0, -10.0, 10.0));
