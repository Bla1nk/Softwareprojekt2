...
class ofApp : public ofBaseApp{
	...
	public:
        ...
        ofxButton button_geno_2;

        void genoButtonPressed_2();
    
        ofxPanel gui_graphen;
        ofxButton button_graph_1;
        ofxButton button_graph_2;
        ofxButton button_graph_3;
        ofxButton button_graph_4;
        ofxButton button_graph_5;
    
        void graph1ButtonPressed();
        void graph2ButtonPressed();
        void graph3ButtonPressed();
        void graph4ButtonPressed();
        void graph5ButtonPressed();
    
        void changeMap(int map);
    
        float maxmin(float min_value, float max_value, float input_value){
            return std::max(min_value, std::min(max_value, input_value));
        }
    
        float limit_digit(float var){
		...
		ofMesh makeRoad();
		ofVec3f crossLines(ofVec2f p1, ofVec2f p2, ofVec2f p3, ofVec2f p4);
