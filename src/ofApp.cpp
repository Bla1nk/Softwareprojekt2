...
void ofApp::draw()
{
    ...
    if (mDisplayGraph_1) mLoadAndDisplaySVGData[0].display(255, 255, 0, 1);
    if (mDisplayGraph_2) mLoadAndDisplaySVGData[1].display(0, 255, 255, 1);
    if (mDisplayGraph_3) mLoadAndDisplaySVGData[2].display(0, 255, 0, 1);
    if (mDisplayGraph_4) mLoadAndDisplaySVGData[3].display(255, 102, 178, 1);
    if (mDisplayGraph_5) mLoadAndDisplaySVGData[4].display(255, 0, 0, 1);
}
