...
void ofApp::setup()
{
	...
	gui_pheno.add(gui_ROTATION_MAX_SPEED.setup("Rotation maximum speed", "1.5"));
	...
	gui_geno.setup("Genotype", "Configuration System", ofGetWidth() * 0.4, ofGetHeight() * 0.7);
	...
	gui_geno.add(gui_INIT_FITNESS.setup("Init Fitness", "1000"));
